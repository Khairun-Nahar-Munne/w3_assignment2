...
function updateGallery() {
  ...
  photoCount.textContent = `${currentIndex + 1}/5`;
...
copyLinkButton.addEventListener('click', () => {
  copyToClipboard('https://www.vrbo.com/2983918?dateless=true&x_pwa=1&rfrr=HSR&pwa_ts=1730820725756&referrerUrl=aHR0cHM6Ly93d3cudnJiby5jb20vSG90ZWwtU2VhcmNo&useRewards=false&adults=2&regionId=956&destination=Cox%27s+Bazar%2C+Chittagong+Division%2C+Bangladesh&destType=MARKET&latLong=21.360771%2C92.020443&privacyTrackingState=CAN_TRACK&searchId=d68f7778-3b3e-4d74-9726-4f9a2d1c5497&sort=RECOMMENDED&userIntent=&expediaPropertyId=84083026&propertyName=Opelia+Beach+Resort+%3Cbr%3EBehind+KFC%2C+120m+inside%2C+1+minute+walking+distance+from+KFC://example.com');
  sharePopup.classList.add('hidden');
});
